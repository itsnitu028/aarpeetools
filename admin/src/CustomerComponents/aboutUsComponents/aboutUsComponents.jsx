...
const AboutUsComponents = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center py-8 px-2">
      <div className="text-5xl font-bold mb-4 text-[#6d65c6] text-center">
        About Us
      </div>
      ...
      <button
        className="px-8 py-3 rounded-full font-medium bg-[#2c3e50] text-white text-lg shadow-md focus:outline-none focus:ring-2 focus:ring-[#BE3144] mx-auto hover:text-black"
